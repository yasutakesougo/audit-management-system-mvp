# 📋 Nightly Issue Drafts — 2026-03-25

> Generated by nightly-patrol Phase B — 2026-03-25

## サマリー

| # | Severity | Category | Title |
|:-:|:--------:|----------|-------|
| 1 | 🔴 critical | test-coverage | [test] テスト未整備 9 feature のテスト追加 |
| 2 | 🟠 high | large-file | [refactor] 巨大ファイル 5 件を監視・段階分割 |
...
## 1. 🔴 [critical] [test] テスト未整備 9 feature のテスト追加
...
テストファイルが 0 件の feature ディレクトリが 9 個あり、閾値 (2件) を超えています。
...
## 2. 🟠 [high] [refactor] 巨大ファイル 5 件を監視・段階分割

...
| 6 | `billing` | Billing | 請求・精算を行う | viewer | No |
...
| `/billing` | 請求処理 | `BillingPage` | viewer |
...
> 全 57 ドメインのうち、約 65% が B ランク以上であり、主要な業務機能は概ね実装されている。
...
| `RequireAudience requiredRole="reception"` | `/users`, `/staff/attendance`, `/records/monthly` | 受付以上 |

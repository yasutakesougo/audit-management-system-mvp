...
- 症状:
  ...
  - バナーに `モニタリング長期未実施（n日）` / `モニタリング未実施（n日）` が継続して表示される
- 主な原因:
...
- 症状:
  - Act が未完了のまま変化しない
  - バナーに `再評価長期未実施（n日）` / `再評価未実施（n日）` が継続して表示される
- 主な原因:
  - `PlanningSheetId` 不一致
...
4. 以下の補助アラートが表示されることを確認する。
   - Check 状態: `モニタリング長期未実施（n日）` / `モニタリング未実施（n日）` / `モニタリング確認推奨（n日）`
   - Act 状態: `再評価長期未実施（n日）` / `再評価未実施（n日）` / `再評価確認推奨（n日）`
...
| --- | --- | --- | --- | --- |
| Check 滞留 | 14日以上 | `p0` | モニタリング長期未実施（n日） | 当日中にモニタリング確認 |
| Check 滞留 | 7〜13日 | `p1` | モニタリング未実施（n日） | 近日中にモニタリング確認 |
| Check 滞留 | 0〜6日 | `p2` | モニタリング確認推奨（n日） | 定例確認で対応 |
| Act 滞留 | 14日以上 | `p0` | 再評価長期未実施（n日） | 当日中に再評価入力確認 |
| Act 滞留 | 7〜13日 | `p1` | 再評価未実施（n日） | 近日中に再評価入力確認 |
| Act 滞留 | 0〜6日 | `p2` | 再評価確認推奨（n日） | 定例確認で対応 |
...
- Check / Act の文言には経過日数（`n日`）を付与して表示する。
- 日数は「最後の完了日からの経過日数」。未来日・誤登録日は `0日` として扱うため、元データの日付を確認する。

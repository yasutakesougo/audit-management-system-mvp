...
vi.mock('../staffAlternativeEngine', () => ({
  ...
  suggestStaffAlternatives: () => [
    { id: 'staff-1', name: '田中太郎', availability: 'available', reason: '経験豊富な職員' },
    { id: 'staff-2', name: '佐藤花子', availability: 'available', reason: '空きがある職員' }
  ]
}));
...
vi.mock('../vehicleAlternativeEngine', () => ({
  ...
  suggestVehicleAlternatives: () => [
    { id: 'vehicle-1', name: '車両A', availability: 'available', reason: '利用可能' },
    { id: 'vehicle-2', name: '車両B', availability: 'available', reason: '車椅子対応' }
  ]
}));
...
vi.mock('../roomAlternativeEngine', () => ({
  ...
  suggestRoomAlternatives: () => [
    { id: 'room-1', name: '会議室A', availability: 'available', reason: '十分な収容人数' },
    { id: 'room-2', name: '会議室B', availability: 'available', reason: '必要設備あり' }
  ],
  suggestEquipmentAlternatives: () => [
    { id: 'eq-1', name: 'プロジェクター', availability: 'available', reason: '利用可能' },
    { id: 'eq-2', name: 'ホワイトボード', availability: 'available', reason: '代替利用可能' }
  ]
}));
...
const mockConflict: ScheduleConflict = {
  idA: 'schedule-1',
  idB: 'schedule-2',
  kind: 'vehicle-double-booking' as ConflictKind,

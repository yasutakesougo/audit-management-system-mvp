...
test.describe('reception attendance bulk action guard e2e', () => {
  test.use({
  ...
  test('reception can bulk-save attendance updates', async ({ page }) => {
    ...
    const saveButton = page.getByTestId('staff-attendance-bulk-save');
  ...
  test('admin can bulk-save attendance updates', async ({ page }) => {

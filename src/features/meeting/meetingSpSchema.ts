/**
 * meetingSpSchema.ts — SharePoint list/field/view/permission schema definitions
 * for the Meeting System (朝会・夕会).
 *
 * Phase 4C: External Data 布石
 *
 * Extracted from meetingSharePointSchema.ts to keep each concern in a dedicated file.
 *
 * Usage:
  ...
  "permissions": [
    {
      "listTitle": "MeetingSessions",
      "permissions": [
        { "principal": "会議司会者", "permissionLevel": "Contribute" },
        { "principal": "職員", "permissionLevel": "Read" }
      ]
    },
    {
      "listTitle": "MeetingStepRecords",
    ...
    },
    {
      ...
      "permissions": [
        { "principal": "会議司会者", "permissionLevel": "Contribute" },
        { "principal": "職員", "permissionLevel": "Contribute" }
      ]
    }
  ]
};

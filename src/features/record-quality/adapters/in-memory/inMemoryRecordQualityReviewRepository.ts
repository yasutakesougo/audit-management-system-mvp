...
} from '../../domain/recordQualityReview';
import type {
  RecordQualityReviewRecordId,
  RecordQualityReviewRepository,
} from '../../ports/recordQualityReviewRepository';
  ...
  implements RecordQualityReviewRepository
{
  ...
  async getReview(recordId: RecordQualityReviewRecordId): Promise<RecordQualityReviewDraft | null> {
...
function sanitizeRecordQualityReview(review: RecordQualityReviewDraft): RecordQualityReviewDraft {
  return {
    ...
    originalRecord: { recordId: review.recordId },

...
export const SpUserMasterItemSchema = z.object({
  ...
  RequiresToiletGuidance: z.boolean().nullish().default(false),
  ToiletGuidanceNote: z.string().nullish(),
...
export const UserMasterDomainSchema = SpUserMasterItemSchema.transform((sp) => ({
  ...
  RequiresToiletGuidance: !!sp.RequiresToiletGuidance,
  ToiletGuidanceNote: sp.ToiletGuidanceNote ?? null,
...
export const UserCoreSchema = z.object({
  ...
  RequiresToiletGuidance: z.boolean().nullable().optional(),
  ToiletGuidanceNote: z.string().nullable().optional(),

...
export const ATTENDANCE_USERS_CANDIDATES = {
  ...
  title: ['FullName', 'FullNameKana', 'Title', 'fullName', 'fullname'],
  isTransportTarget: ['IsTransportTarget', 'isTransportTarget'],
  standardMinutes: ['StandardMinutes', 'standardMinutes'],
  isActive: ['IsActive', 'Active', 'isActive'],
  serviceEndDate: ['ServiceEndDate', 'ServiceEnd', 'UsageEndDate', 'serviceEndDate'],
  usageStatus: ['UsageStatus', 'Status', 'usageStatus'],

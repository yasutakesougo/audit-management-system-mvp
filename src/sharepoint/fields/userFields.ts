...
const CANDIDATE_REQUIRES_TOILET_GUIDANCE = ['RequiresToiletGuidance', 'RequiresToiletGuidance0', 'cr013_requiresToiletGuidance', 'Requires_x0020_Toilet_x0020_Guid', 'Requires Toilet Guidance'];
const CANDIDATE_TOILET_GUIDANCE_NOTE = ['ToiletGuidanceNote', 'ToiletGuidanceNote0', 'cr013_toiletGuidanceNote', 'Toilet_x0020_Guidance_x0020_Note', 'Toilet Guidance Note'];

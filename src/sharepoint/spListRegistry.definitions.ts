...
// ── 6. 引き継ぎ・支援計画系 ────────────────────────────
  ...
  },
  {
    ...
    provisioningFields: [
      { internalName: 'UserId', type: 'Text', displayName: 'User ID', required: true, indexed: true, isSilent: true, candidates: ['UserId', 'UserCode', 'User_x0020_ID'] },
      { internalName: 'PlanningSheetId', type: 'Text', displayName: 'Planning Sheet ID', required: true, isSilent: true, candidates: ['PlanningSheetId', 'Planning_x0020_Sheet_x0020_ID'] },
      { internalName: 'PeriodStart', type: 'DateTime', displayName: 'Period Start', dateTimeFormat: 'DateOnly' },
      { internalName: 'PeriodEnd', type: 'DateTime', displayName: 'Period End', required: true, dateTimeFormat: 'DateOnly', isSilent: true, candidates: ['PeriodEnd', 'Period_x0020_End'] },
  ...
  },
  {
    ...
    provisioningFields: [
      { internalName: 'PlanningSheetId', type: 'Text', displayName: 'Planning Sheet ID', required: true, indexed: true, isSilent: true, candidates: ['PlanningSheetId', 'Planning_x0020_Sheet_x0020_ID'] },
      ...
      { internalName: 'ReassessmentDate', type: 'DateTime', displayName: 'Reassessment Date', required: true, dateTimeFormat: 'DateOnly', isSilent: true, candidates: ['ReassessmentDate', 'Reassessment_x0020_Date'] },
      { internalName: 'Summary', type: 'Note', displayName: 'Summary', richText: false },
      ...
      { internalName: 'VersionNo', type: 'Number', displayName: 'Version No', governance: 'allow' },
...
// ── 7. コンプライアンス・診断系 ────────────────────────
  ...
  },
  {
    ...
    provisioningFields: [
      ...
      { internalName: 'Severity', type: 'Text', displayName: 'Severity', isSilent: true, candidates: ['Severity', 'Level', '_Level'] },
      { internalName: 'ResolutionType', type: 'Text', displayName: 'Resolution Type', candidates: ['Resolution_x0020_Type', 'ResolutionType'] },
      { internalName: 'DriftType', type: 'Text', displayName: 'Drift Type', isSilent: true, candidates: ['Drift_x0020_Type', 'DriftType'] },
  ...
  },
  {
    ...
    provisioningFields: [
      ...
      { internalName: 'ListKey', type: 'Text', displayName: 'List Key', required: true, indexed: true, isSilent: true, candidates: ['ListKey', 'List_x0020_Key'] },
      ...
      { internalName: 'Status', type: 'Text', displayName: 'Status' },
      { internalName: 'Payload', type: 'Note', displayName: 'Payload JSON', richText: false, governance: 'allow' },
    ],
  },
];
...
// ── 8. その他 ─────────────────────────────────────────
  ...
  },
  {
    ...
    provisioningFields: [
      ...
      { internalName: 'SpO2', type: 'Number', displayName: 'SpO2', candidates: ['SpO2', 'SPO2'] },

...
// ── 1. マスタ系 ──────────────────────────────────────────
  {
    ...
    provisioningFields: [
      ...
      { internalName: 'GrantMunicipality', type: 'Text', displayName: 'Grant Municipality', candidates: ['GrantMunicipality', 'GrantMunicipality0', 'Grant_x0020_Municipality'] },
      { internalName: 'GrantPeriodStart', type: 'DateTime', displayName: 'Grant Period Start', dateTimeFormat: 'DateOnly', candidates: ['GrantPeriodStart', 'GrantPeriodStart0', 'Grant_x0020_Period_x0020_Start'] },
      { internalName: 'GrantPeriodEnd', type: 'DateTime', displayName: 'Grant Period End', dateTimeFormat: 'DateOnly', candidates: ['GrantPeriodEnd', 'GrantPeriodEnd0', 'Grant_x0020_Period_x0020_End'] },
      { internalName: 'UserCopayLimit', type: 'Text', displayName: 'User Copay Limit', candidates: ['UserCopayLimit', 'UserCopayLimit0', 'User_x0020_Copay_x0020_Limit'] },
      { internalName: 'MealAddition', type: 'Text', displayName: 'Meal Addition', candidates: ['MealAddition', 'MealAddition0', 'Meal_x0020_Addition'] },
      { internalName: 'CopayPaymentMethod', type: 'Text', displayName: 'Copay Payment Method', candidates: ['CopayPaymentMethod', 'CopayPaymentMethod0', 'Copay_x0020_Payment_x0020_Method'] },
    ],
  },
  {
...
// ── 3. 出席管理系 ──────────────────────────────────────
  ...
  },
  {
    ...
    provisioningFields: [
      ...
      { internalName: 'CntAttendIn', type: 'Number', displayName: 'Attendance In Count', candidates: ['CntAttendIn', 'Attendance_x0020_In_x0020_Count'] },
      { internalName: 'CntAttendOut', type: 'Number', displayName: 'Attendance Out Count', candidates: ['CntAttendOut', 'Attendance_x0020_Out_x0020_Count'] },
      ...
      { internalName: 'IsEarlyLeave', type: 'Boolean', displayName: 'Early Leave', candidates: ['IsEarlyLeave', 'Early_x0020_Leave'] },
      { internalName: 'UserConfirmedAt', type: 'DateTime', displayName: 'User Confirmed Time', dateTimeFormat: 'DateTime', candidates: ['UserConfirmedAt', 'User_x0020_Confirmed_x0020_Time'] },
      { internalName: 'AbsentMorningContacted', type: 'Boolean', displayName: 'Absent Morning Contacted', candidates: ['AbsentMorningContacted', 'Absent_x0020_Morning_x0020_Conta'] },
      { internalName: 'AbsentMorningMethod', type: 'Text', displayName: 'Absent Morning Method', candidates: ['AbsentMorningMethod', 'Absent_x0020_Morning_x0020_Metho'] },
      ...
      { internalName: 'IsAbsenceAddonClaimable', type: 'Boolean', displayName: 'Absence Add-on Claimable', candidates: ['IsAbsenceAddonClaimable', 'IsAbsenceAddonClaimable'] },
    ],
  },
  {
...
// ── 6. 引き継ぎ・支援計画系 ────────────────────────────
  ...
  },
  {
    ...
    provisioningFields: [
      ...
      { internalName: 'PlanningSheetId', type: 'Text', displayName: 'Planning Sheet ID', required: true, candidates: ['PlanningSheetId', 'Planning_x0020_Sheet_x0020_ID'] },
      { internalName: 'PeriodStart', type: 'DateTime', displayName: 'Period Start', dateTimeFormat: 'DateOnly' },
      { internalName: 'PeriodEnd', type: 'DateTime', displayName: 'Period End', required: true, dateTimeFormat: 'DateOnly', candidates: ['PeriodEnd', 'Period_x0020_End'] },
  ...
  },
  {
    ...
    provisioningFields: [
      { internalName: 'PlanningSheetId', type: 'Text', displayName: 'Planning Sheet ID', required: true, indexed: true, candidates: ['PlanningSheetId', 'Planning_x0020_Sheet_x0020_ID'] },
      ...
      { internalName: 'ReassessmentDate', type: 'DateTime', displayName: 'Reassessment Date', required: true, dateTimeFormat: 'DateOnly', candidates: ['ReassessmentDate', 'Reassessment_x0020_Date'] },
      { internalName: 'Summary', type: 'Note', displayName: 'Summary', richText: false },
...
// ── 7. コンプライアンス・診断系 ────────────────────────
  ...
  },
  {
    ...
    provisioningFields: [
      ...
      { internalName: 'ListKey', type: 'Text', displayName: 'List Key', required: true, indexed: true, candidates: ['ListKey', 'List_x0020_Key'] },
...
// ── 8. その他 ─────────────────────────────────────────
  ...
  },
  {
    ...
    provisioningFields: [
      { internalName: 'UserLookupId', type: 'Number', displayName: 'User Lookup ID', required: true, candidates: ['UserLookupId', 'User_x0020_Lookup_x0020_ID'] },
      { internalName: 'ObservedAt', type: 'DateTime', displayName: 'Observed At', required: true, dateTimeFormat: 'DateTime', candidates: ['ObservedAt', 'Observed_x0020_At'] },
      ...
      { internalName: 'IdempotencyKey', type: 'Text', displayName: 'Idempotency Key', candidates: ['IdempotencyKey'] },
      { internalName: 'Source', type: 'Text', displayName: 'Source', candidates: ['Source'] },
      { internalName: 'LocalTimeZone', type: 'Text', displayName: 'Local Time Zone', candidates: ['LocalTimeZone', 'Local_x0020_Time_x0020_Zone'] },
      { internalName: 'CreatedBy', type: 'Text', displayName: 'Created By', candidates: ['CreatedBy', 'Created_x0020_By'] },
      { internalName: 'DeviceId', type: 'Text', displayName: 'Device ID', candidates: ['DeviceId', 'Device_x0020_ID'] },
      { internalName: 'VitalsJson', type: 'Note', displayName: 'Vitals JSON', richText: false, candidates: ['VitalsJson', 'Vitals_x0020_JSON'] },
    ],
  },
  {
    key: 'official_forms',
  ...
  },
  {
    ...
    provisioningFields: [
      ...
      { internalName: 'OrdererCode', type: 'Text', displayName: 'Orderer Code', required: true, governance: 'allow', candidates: ['OrdererCode', 'Orderer_x0020_Code'] },
      { internalName: 'OrdererName', type: 'Text', displayName: 'Orderer Name', governance: 'allow', candidates: ['OrdererName', 'Orderer_x0020_Name'] },
      { internalName: 'OrderCount', type: 'Number', displayName: 'Order Count', governance: 'allow', candidates: ['OrderCount', 'Order_x0020_Count'] },
  ...
  },
  {
    ...
    provisioningFields: [
      ...
      { internalName: 'LastUpdated', type: 'DateTime', displayName: 'Last Updated', candidates: ['LastUpdated', 'LastAggregatedAt', 'Last_x0020_Updated'] },
      ...
      { internalName: 'KPI_CompletedRows', type: 'Number', displayName: 'Completed Rows', candidates: ['KPI_CompletedRows', 'Completed_x0020_Rows', 'CompletedCount'] },
      { internalName: 'KPI_InProgressRows', type: 'Number', displayName: 'In Progress Rows', candidates: ['KPI_InProgressRows', 'In_x0020_Progress_x0020_Rows', 'PendingCount'] },
      { internalName: 'KPI_EmptyRows', type: 'Number', displayName: 'Empty Rows', candidates: ['KPI_EmptyRows', 'Empty_x0020_Rows', 'EmptyCount'] },
      { internalName: 'KPI_SpecialNotes', type: 'Number', displayName: 'Special Notes', candidates: ['KPI_SpecialNotes', 'Special_x0020_Notes', 'SpecialNoteCount'] },
      { internalName: 'KPI_Incidents', type: 'Number', displayName: 'Incidents', candidates: ['KPI_Incidents', 'Incidents', 'IncidentCount'] },

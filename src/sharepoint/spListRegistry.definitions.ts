...
// ── 3. 出席管理系 ──────────────────────────────────────
  ...
  },
  {
    ...
    provisioningFields: [
      ...
      { internalName: 'CntAttendIn', type: 'Number', displayName: 'Attendance In Count', isSilent: true, candidates: ['CntAttendIn', 'Attendance_x0020_In_x0020_Count'] },
      { internalName: 'CntAttendOut', type: 'Number', displayName: 'Attendance Out Count', isSilent: true, candidates: ['CntAttendOut', 'Attendance_x0020_Out_x0020_Count'] },
      ...
      { internalName: 'IsEarlyLeave', type: 'Boolean', displayName: 'Early Leave', isSilent: true, candidates: ['IsEarlyLeave', 'Early_x0020_Leave'] },
      { internalName: 'UserConfirmedAt', type: 'DateTime', displayName: 'User Confirmed Time', dateTimeFormat: 'DateTime', isSilent: true, candidates: ['UserConfirmedAt', 'User_x0020_Confirmed_x0020_Time'] },
      { internalName: 'AbsentMorningContacted', type: 'Boolean', displayName: 'Absent Morning Contacted', isSilent: true, candidates: ['AbsentMorningContacted', 'Absent_x0020_Morning_x0020_Conta'] },
      { internalName: 'AbsentMorningMethod', type: 'Text', displayName: 'Absent Morning Method', isSilent: true, candidates: ['AbsentMorningMethod', 'Absent_x0020_Morning_x0020_Metho'] },
      ...
      { internalName: 'IsAbsenceAddonClaimable', type: 'Boolean', displayName: 'Absence Add-on Claimable', isSilent: true, candidates: ['IsAbsenceAddonClaimable', 'IsAbsenceAddonClaimable'] },
    ],
  },
  {
...
// ── 8. その他 ─────────────────────────────────────────
  ...
  },
  {
    ...
    provisioningFields: [
      ...
      { internalName: 'DisplayName', type: 'Text', displayName: 'Display Name', isSilent: true, candidates: ['DisplayName', 'Display_x0020_Name'] },
      { internalName: 'LastUpdated', type: 'DateTime', displayName: 'Last Updated', isSilent: true, candidates: ['LastUpdated', 'LastAggregatedAt', 'Last_x0020_Updated'] },
      ...
      { internalName: 'KPI_PlannedRows', type: 'Number', displayName: 'Planned Rows', isSilent: true, candidates: ['KPI_PlannedRows', 'Planned_x0020_Rows'] },
      { internalName: 'KPI_CompletedRows', type: 'Number', displayName: 'Completed Rows', isSilent: true, candidates: ['KPI_CompletedRows', 'Completed_x0020_Rows', 'CompletedCount'] },
      { internalName: 'KPI_InProgressRows', type: 'Number', displayName: 'In Progress Rows', isSilent: true, candidates: ['KPI_InProgressRows', 'In_x0020_Progress_x0020_Rows', 'PendingCount'] },
      { internalName: 'KPI_EmptyRows', type: 'Number', displayName: 'Empty Rows', isSilent: true, candidates: ['KPI_EmptyRows', 'Empty_x0020_Rows', 'EmptyCount'] },
      { internalName: 'KPI_SpecialNotes', type: 'Number', displayName: 'Special Notes', isSilent: true, candidates: ['KPI_SpecialNotes', 'Special_x0020_Notes', 'SpecialNoteCount'] },
      { internalName: 'KPI_Incidents', type: 'Number', displayName: 'Incidents', isSilent: true, candidates: ['KPI_Incidents', 'Incidents', 'IncidentCount'] },
      { internalName: 'CompletionRate', type: 'Number', displayName: 'Completion Rate' },
      { internalName: 'FirstEntryDate', type: 'DateTime', displayName: 'First Entry Date', dateTimeFormat: 'DateOnly', isSilent: true, candidates: ['FirstEntryDate', 'First_x0020_Entry_x0020_Date'] },
      { internalName: 'LastEntryDate', type: 'DateTime', displayName: 'Last Entry Date', dateTimeFormat: 'DateOnly', isSilent: true, candidates: ['LastEntryDate', 'Last_x0020_Entry_x0020_Date'] },
      { internalName: 'IdempotencyKey', type: 'Text', displayName: 'Idempotency Key', isSilent: true, candidates: ['IdempotencyKey', 'Idempotency_x0020_Key'] },
    ],
  },

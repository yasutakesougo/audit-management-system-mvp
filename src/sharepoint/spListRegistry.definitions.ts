...
// ── 1. マスタ系 ──────────────────────────────────────────
  ...
  },
  {
    ...
    provisioningFields: [
      ...
      { internalName: 'Work_x0020_Days', type: 'Text', displayName: 'Work Days (Legacy)', isSilent: true },
...
// ── 2. 日々の記録系 ─────────────────────────────────────
  ...
  },
  {
    ...
    provisioningFields: [
      ...
      { internalName: 'ISPId', type: 'Text', displayName: 'ISP ID', candidates: ['ISPId', 'ISPLookupId', 'cr013_ispId'] },
  ...
  },
  {
    ...
    provisioningFields: [
      ...
      { internalName: 'UserID', type: 'Text', displayName: 'User ID', required: true, indexed: true, candidates: ['UserID', 'User_x0020_ID', 'Title'] },
      { internalName: 'Version', type: 'Number', displayName: 'Version', default: 1, candidates: ['Version', 'VersionNo', 'cr013_version'] },
      { internalName: 'Status', type: 'Text', displayName: 'Status' },
      { internalName: 'Payload', type: 'Note', displayName: 'Row Data JSON', richText: false, candidates: ['Payload', 'PayloadJSON', 'cr013_payload'] },
  ...
  },
  {
    ...
    provisioningFields: [
      ...
      { internalName: 'Goals', type: 'Note', displayName: 'Goals JSON', richText: false, candidates: ['Goals', 'goals', 'GoalIds', 'cr013_goals'] },
...
// ── 6. 引き継ぎ・支援計画系 ────────────────────────────
  ...
  },
  {
    ...
    provisioningFields: [
      ...
      { internalName: 'VersionNo', type: 'Number', displayName: 'Version No', isSilent: true },
...
// ── 7. コンプライアンス・診断系 ────────────────────────
  ...
  },
  {
    ...
    provisioningFields: [
      ...
      { internalName: 'Status', type: 'Text', displayName: 'Status' },
      { internalName: 'Payload', type: 'Note', displayName: 'Payload JSON', richText: false, isSilent: true },
    ],
  },
];

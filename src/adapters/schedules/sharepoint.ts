...
export async function update(id: string, patch: Partial<Schedule>, options?: { signal?: AbortSignal }): Promise<Schedule> {
...
export async function checkConflicts(assignee: string, start: string, end: string, options?: { signal?: AbortSignal }): Promise<boolean> {

...
const alignmentChecklist = [
  ...
  '強度行動障害支援加算の算定要件を満たす項目（支援時間、対応者、評価）を欠かさず記録できること。',
      ...
      <Paper elevation={2} sx={{ p: { xs: 3, md: 4 } }}>
        <Stack spacing={2}>
          ...
          <Alert severity="info" variant="outlined">
            強度行動障害の支援現場における「支援手順兼記録」の位置づけを整理し、既存の事業所時間割記録・健康記録との連携観点をまとめたレポートです。入力機能の実装に先立ち、チームで共有すべき情報構造と運用ルールを可視化します。
          </Alert>
          <Typography variant="body2" color="text.secondary">
            ※本ページは将来の入力画面の設計指針を示すドキュメントであり、現時点では支援データの参照・設計レビュー用として活用します。
          </Typography>
          <Chip label="強度行動障害支援" color="warning" sx={{ alignSelf: 'flex-start' }} />

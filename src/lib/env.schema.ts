...
export const envSchema = z.object({
  ...
  VITE_SP_LIST_USERS: z.string().optional().default('Users_Master'),
  VITE_SP_LIST_DAILY: z.string().optional().default('SupportRecord_Daily'),
  VITE_SP_LIST_STAFF: z.string().optional().default('Staff_Master'),
  ...
  VITE_SP_LIST_SUPPORT_CASES: z.string().optional().default('SupportCases'),
  VITE_SP_LIST_SUPPORT_CASE_DOCUMENTS: z.string().optional().default('SupportCaseDocuments'),
  VITE_SP_LIST_SUPPORT_CASE_EVENTS: z.string().optional().default('SupportCaseEvents'),
  VITE_SP_LIBRARY_SUPPORT_CASE_RESTRICTED_DOCUMENTS: z.string().optional().default('SupportCaseRestrictedDocuments'),
  ...
  VITE_FEATURE_SUPPORT_CASE_SHAREPOINT_DIAGNOSTICS: zBoolFromString.optional().default(false),

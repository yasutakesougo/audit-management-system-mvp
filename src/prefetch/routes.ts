...
export const PREFETCH_KEYS = {
  ...
  icebergPdca: 'route:support-procedures:time-based',
  icebergPdcaBoard: 'route:analysis:iceberg-pdca',
...
export const ROUTE_IMPORTERS: PrefetchRegistry = {
  ...
  [PREFETCH_KEYS.users]: () => import('@/features/users/UsersPanel'),
  [PREFETCH_KEYS.staff]: () => import('@/features/staff/StaffPanel'),
  [PREFETCH_KEYS.dailyMenu]: () => import('@/pages/DailyRecordMenuPage'),
  [PREFETCH_KEYS.schedulesWeek]: () => import('@/features/schedules/routes/WeekPage'),
  [PREFETCH_KEYS.schedulesDay]: () => import('@/features/schedules/routes/WeekPage'),
  [PREFETCH_KEYS.schedulesMonth]: () => import('@/features/schedules/routes/MonthPage'),
  ...
  [PREFETCH_KEYS.icebergPdca]: () => import('@/pages/TimeBasedSupportRecordPage'),
  [PREFETCH_KEYS.icebergPdcaBoard]: () => import('@/pages/IcebergPdcaPage'),
...
const neighbors: NeighborMap = {
  ...
  [PREFETCH_KEYS.dashboard]: [
    ...
    PREFETCH_KEYS.icebergPdcaBoard,

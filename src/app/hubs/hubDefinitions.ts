...
export const HUB_DEFINITIONS: Record<HubId, HubDefinition> = {
  ...
  schedules: {
    ...
    purpose: '予定を確認・調整する',
    emptyStateTitle: '表示できる導線がありません',
    emptyStateDescription: 'スケジュール関連の権限を確認してください。',
    primaryCtaLabel: '週間予定を開く',
    telemetryName: 'hub_schedules_view',
    requiredRole: 'viewer',
    pageTitle: 'Schedules',
    breadcrumbLabel: 'Schedules',
    analyticsName: 'hub_schedules',
    rootPath: '/schedules/week',
    navLabel: 'スケジュール',
    activePathPrefixes: [
      '/schedules',
      '/schedule',
  ...
  operations: {
    ...
    secondaryEntries: [
      ...
      },
      {
        ...
        title: 'コンプラ報告',
        description: 'コンプライアンス報告（スタッフ用）',
        to: '/compliance',
        kpiWeight: 68,
        usagePriority: 7,
      },
      {
        id: 'operations-compliance-dashboard',
        title: '適正化運用ダッシュボード',
        description: '三要素充足状況の可視化',
      ...
      {
        id: 'operations-regulatory-dashboard',
        title: '制度遵守ダッシュボード',
        description: '加算判定と制度要件の自動監査',
  ...
  billing: {
    ...
    emptyStateDescription: '請求機能は全スタッフが利用できます。',
    ...
    primaryEntries: [
      {
        ...
        kpiWeight: 98,
        usagePriority: 1,
        rolePriority: { viewer: 1, reception: 2, admin: 3 },
      },
    ],
    secondaryEntries: [
      {
  ...
  platform: {
    ...
    rootPath: '/platform',
    navLabel: 'Platform',
    activePathPrefixes: ['/platform', '/admin', '/checklist', '/audit', '/settings', '/admin/telemetry', '/admin/status'],

 ...
 *
 * Types and constants are defined in navigationConfig.types.ts and re-exported
 * here for public API compatibility.
 *
...
// Import types and constants from extracted types module
import {
    NAV_AUDIENCE,
    NAV_GROUP_I18N_KEYS,
    NAV_GROUP_ORDER,
...
// Consumers can continue importing from '@/app/config/navigationConfig'
export {
    NAV_AUDIENCE,
    NAV_GROUP_I18N_KEYS,
    NAV_GROUP_ORDER,

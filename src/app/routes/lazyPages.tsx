...
export const SuspendedAttendanceRecordPage = createSuspended(AttendanceRecordPage, '通園管理ページを読み込んでいます…');
export const SuspendedTimeFlowSupportRecordPage = createSuspended(TimeFlowSupportRecordPage, '支援記録を読み込んでいます…');
export const SuspendedTimeBasedSupportRecordPage = createSuspended(TimeBasedSupportRecordPage, '時間別支援記録を読み込んでいます…');
...
export const SuspendedHealthObservationPage = createSuspended(HealthObservationPage, '身体記録入力画面を読み込んでいます…');
...
const PlannerAssistDashboardPage = React.lazy(() => import('@/pages/admin/PlannerAssistDashboardPage'));
export const SuspendedPlannerAssistDashboardPage = createSuspended(PlannerAssistDashboardPage, '支援品質アシスト利用状況を読み込んでいます…');

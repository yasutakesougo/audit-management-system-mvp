...
const budgets = [
  ...
  { label: 'Firebase SDK', pattern: /firebase-(?!legacy-).*\.js$/i, limitKb: 480, required: true },
  { label: 'legacy Firebase SDK', pattern: /firebase-legacy-.*\.js$/i, limitKb: 700, required: true },
